...
where
    SchemaName: traits::SchemaName,
{
    schema_name: SchemaName,
    name: Identifier,
}

impl<SchemaName> traits::QualifiedName for QualifiedName<SchemaName> where
    SchemaName: traits::SchemaName
{
}
impl<SchemaName> traits::TableReference for QualifiedName<SchemaName> where
    SchemaName: traits::SchemaName
{
}
